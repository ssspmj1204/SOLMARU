...
//#####################여기까지 title부분################################
		...
		panel.setBackground(new Color(185, 122, 87));
		...
		panel_1.setBackground(new Color(185, 122, 87));
		panel_1.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent arg0) {
				Order_select ordersel = new Order_select();
				frame.setVisible(false);
				ordersel.main(null);
			}
		});
		...
		panel_2.setBackground(new Color(185, 122, 87));
		...
		lblNewLabel.setIcon(new ImageIcon("./../etcImage/dish.png"));
		panel.add(lblNewLabel);

		JLabel lblNewLabel_1 = new JLabel("\uC8FC\uBB38\uD558\uAE30");
		...
		panel_3.setBackground(new Color(185, 122, 87));
		...
		lblNewLabel_4.setIcon(new ImageIcon("./../etcImage/email.png"));
		...
		lblNewLabel_2.setIcon(new ImageIcon("./../etcImage/check-list.png"));
		panel_1.add(lblNewLabel_2);

		JLabel lblNewLabel_3 = new JLabel("\uC8FC\uBB38\uC870\uD68C");
		...
		lblNewLabel_6.setIcon(new ImageIcon("./../etcImage/avatar.png"));
